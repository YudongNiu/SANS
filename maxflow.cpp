...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::set_active(node *i)
{
	if (!i->next)
	{
...
*/
template <typename captype, typename tcaptype, typename flowtype> 
	inline typename FlowGraph<captype,tcaptype,flowtype>::node* FlowGraph<captype,tcaptype,flowtype>::next_active()
{
	node *i;
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::set_orphan_front(node *i)
{
	nodeptr *np;
	i -> parent = ORPHAN;
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::set_orphan_rear(node *i)
{
	nodeptr *np;
	i -> parent = ORPHAN;
	np = nodeptr_block -> New();
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::add_to_changed_list(node *i)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::maxflow_init()
{
	node *i;
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::maxflow_reuse_trees_init()
{
	node* i;
	node* j;
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::augment(arc *middle_arc)
{
	node *i;
	arc *a;
	tcaptype bottleneck;
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::process_source_orphan(node *i)
{
	node *j;
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::process_sink_orphan(node *i)
{
	node *j;
	arc *a0, *a0_min = NULL, *a;
	int d, d_min = INFINITE_D;
...
template <typename captype, typename tcaptype, typename flowtype> 
	flowtype FlowGraph<captype,tcaptype,flowtype>::maxflow(bool reuse_trees, Block<node_id>* _changed_list)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::test_consistency(node* current_node)
{
	node *i;
	arc *a;
	int r;
