...
template <typename captype, typename tcaptype, typename flowtype> 
	FlowGraph<captype, tcaptype, flowtype>::FlowGraph(int node_num_max, int edge_num_max, void (*err_function)(const char *))
	: node_num(0),
	  nodeptr_block(NULL),
...
template <typename captype, typename tcaptype, typename flowtype> 
	FlowGraph<captype,tcaptype,flowtype>::~FlowGraph()
{
	if (nodeptr_block) 
	{ 
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::reset()
{
	node_last = nodes;
	arc_last = arcs;
	node_num = 0;
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	void FlowGraph<captype,tcaptype,flowtype>::reallocate_arcs()
{
