...
template <typename captype, typename tcaptype, typename flowtype> class FlowGraph
{
public:
	typedef enum
	{
	...
	FlowGraph(int node_num_max, int edge_num_max, void (*err_function)(const char *) = NULL);
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline typename FlowGraph<captype,tcaptype,flowtype>::node_id FlowGraph<captype,tcaptype,flowtype>::add_node(int num)
{
	assert(num > 0);
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::add_tweights(node_id i, tcaptype cap_source, tcaptype cap_sink)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::add_edge(node_id _i, node_id _j, captype cap, captype rev_cap)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline typename FlowGraph<captype,tcaptype,flowtype>::arc* FlowGraph<captype,tcaptype,flowtype>::get_first_arc()
{
	return arcs;
}

template <typename captype, typename tcaptype, typename flowtype> 
	inline typename FlowGraph<captype,tcaptype,flowtype>::arc* FlowGraph<captype,tcaptype,flowtype>::get_next_arc(arc* a) 
{
	return a + 1; 
}

template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::get_arc_ends(arc* a, node_id& i, node_id& j)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline tcaptype FlowGraph<captype,tcaptype,flowtype>::get_trcap(node_id i)
{
	assert(i>=0 && i<node_num);
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline captype FlowGraph<captype,tcaptype,flowtype>::get_rcap(arc* a)
{
	assert(a >= arcs && a < arc_last);
	return a->r_cap;
}
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::set_trcap(node_id i, tcaptype trcap)
{
	assert(i>=0 && i<node_num); 
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::set_rcap(arc* a, captype rcap)
{
	assert(a >= arcs && a < arc_last);
	a->r_cap = rcap;
}
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline typename FlowGraph<captype,tcaptype,flowtype>::termtype FlowGraph<captype,tcaptype,flowtype>::what_segment(node_id i, termtype default_segm)
{
	if (nodes[i].parent)
	{
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void FlowGraph<captype,tcaptype,flowtype>::mark_node(node_id _i)
{
	node* i = nodes + _i;
	if (!i->next)
	{
